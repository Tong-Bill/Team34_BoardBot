...
"""
dice_roll = 0 #global
#board_spaces = ([0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08], [0.474062, 0.4, -0.08]) # global
import argparse
import struct
import sys
import copy
...
def subscribeSpace(board_space, rot, pnp, count):
  global dice_roll
  rospy.Subscriber("spaceInfo", Int16, callback) # Topic: spaceInfo; get message, then invoke 'callback()'
   
  print("Dice_roll is:\n")
  print(dice_roll)
  pnp.pick(board_space, rot)  # Pick up at origin
  board_space, count = get_position(count, dice_roll, board_space) # Calc destination 
  pnp.place(board_space, rot) # Go to destination
...
def main():
    rospy.init_node('spaceMovement', anonymous=True)
...
# An orientation for gripper fingers to be overhead and parallel to the obj
    ...
    board_space = ([0.474062, 0.4, -0.08]) # Go
    dice_space = ([0.474062, 0.4, -0.085])
...
#        pnp.roll_dice(dice_space, roll_space, rot)
    while not rospy.is_shutdown():
      count = subscribeSpace(board_space, rot, pnp, count)    # Activate subscription
#      rospy.spin()
