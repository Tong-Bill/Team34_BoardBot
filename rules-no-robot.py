...
class TitleDeedCards(object):
        # Title Deed schema:
        #   {spaceName: [spaceNumber, [base rent, set rent, 1 house rent... hotel rent], mortgage value, build cost]
     ...
     def rentLookup(self, space, isSet = False, numHouses = 0, numHotel = False, isMortgaged = False):
         try:
